...
best_boost_final_model <- finalize_workflow(boost_rf, best_boost_final)
...
best_tree <- select_best(tune_forest)
best_tree_model <- finalize_workflow(forest_wf, best_forest)
